...
__all__ = ('Observable', 'Builder', 'BuilderBase', 'BuilderException', 'Lang')
...
class Lang(Observable):
    ...
    def switch_lang(self, lang):
        ...
        locale_dir = self.source if self.source else locale_dir
        locales = translation('langapp', locale_dir, languages=[lang])
