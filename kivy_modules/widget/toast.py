...
class Toast(ModalView):
	...
	def label_check_texture_size(self, instance, texture_size):
		...
		if texture_width > Window.width:
			...
			textute_width, texture_height = instance.texture_size
#			texture_width, texture_height = instance.text_size[0], instance.texture_size[1]
			
		self.size = (texture_width + 25, texture_height + 25)
#			self.size = (Window.width - dp(10), texture_height + 25)
