...
r = FlexFactory.register

r('FlexButton', module='kivy_modules.widget.button')
r('FlexIconButton', module='kivy_modules.widget.button')
r('FlexImageButton', module='kivy_modules.widget.button')

# external view
r('FlexGif', module='kivy_modules.widget.gif')
r('FlexCalendar', module='kivy_modules.widget.calendar')

# layout
r('FlexLayout', module='kivy_modules.widget.layout')
